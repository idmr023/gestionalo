...
<?php endif; ?>
        ...
        <div class="hidden md:flex items-center gap-6">
            <a href="<?php echo e(route('search')); ?>" class="text-primary/40 hover:text-accent transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
            </a>
            <a href="<?php echo e(config('site.contact.whatsapp_url')); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-primary/60 hover:text-accent transition">
                ...
                <?php echo e(config('site.contact.phone')); ?>

            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('client.dashboard')); ?>" class="text-sm text-primary/60 hover:text-accent transition font-medium">Mi cuenta</a>
            <?php else: ?>

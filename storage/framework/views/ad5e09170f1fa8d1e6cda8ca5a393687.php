...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <p class="text-center text-sm text-primary/40 mt-6">
                ¿No tienes cuenta?
                <a href="<?php echo e(route('register')); ?>" class="text-accent hover:text-accent-hover font-medium">Regístrate</a>
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\idmr_\OneDrive\Escritorio\gestionalo\resources\views/auth/login.blade.php ENDPATH**/ ?>
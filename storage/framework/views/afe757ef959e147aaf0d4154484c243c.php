...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" required
                                      class="w-full border border-[rgba(15,23,42,0.1)] px-4 py-3 text-sm text-primary focus:border-accent transition outline-none"><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <ul class="space-y-4 text-sm text-primary/60">
                            <li class="flex items-center gap-3">
                                ...
                                <a href="mailto:<?php echo e(config('site.contact.email')); ?>" class="hover:text-accent transition"><?php echo e(config('site.contact.email')); ?></a>
                            </li>
                            <li class="flex items-center gap-3">
                                ...
                                <a href="<?php echo e(config('site.contact.whatsapp_url')); ?>" target="_blank" rel="noopener noreferrer" class="hover:text-accent transition"><?php echo e(config('site.contact.phone')); ?></a>
                            </li>
                            <li class="flex items-start gap-3">
                                ...
                                <span><?php echo e(config('site.contact.address')); ?></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('client.dashboard')); ?>" class="inline-flex items-center gap-2 bg-accent hover:bg-accent-hover text-white font-semibold px-6 py-3 transition text-sm tracking-wide">
                            Agendar cita
...
<?php endif; ?>
<?php /**PATH C:\Users\idmr_\OneDrive\Escritorio\gestionalo\resources\views/pages/contacto.blade.php ENDPATH**/ ?>
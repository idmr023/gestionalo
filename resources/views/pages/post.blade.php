<x-layouts.app :title="$post->title">
    ...
    <main class="pt-[72px] min-h-screen bg-white py-32">
        <div x-data="blogActions({ slug: '{{ $post->slug }}' })" x-init="initBlog" class="max-w-3xl mx-auto px-6 md:px-8">
            <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 text-sm text-primary/40 hover:text-accent transition mb-12">
            ...
            <h1 class="text-4xl md:text-5xl font-bold font-display text-primary mt-4 mb-8 leading-[1.05]">{{ $post->title }}</h1>
                ...
                <div class="flex gap-6">
                    ...
                    <div class="relative">
                        ...
                        <div x-show="showShare" x-cloak @click.away="showShare = false" class="absolute top-full right-0 mt-2 bg-white border border-[rgba(15,23,42,0.06)] z-50 w-48">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}&quote={{ urlencode($post->title) }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-4 py-3 hover:bg-surface transition border-b border-[rgba(15,23,42,0.06)] text-sm text-primary/70">
                            ...
                            <a href="https://twitter.com/intent/tweet?text={{ urlencode($post->title) }}&url={{ urlencode(request()->url()) }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-4 py-3 hover:bg-surface transition border-b border-[rgba(15,23,42,0.06)] text-sm text-primary/70">
                            ...
                            <a href="https://wa.me/?text={{ urlencode($post->title.' — '.request()->url()) }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-4 py-3 hover:bg-surface transition border-b border-[rgba(15,23,42,0.06)] text-sm text-primary/70">
                            ...
                            <a href="https://t.me/share/url?url={{ urlencode(request()->url()) }}&text={{ urlencode($post->title) }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-4 py-3 hover:bg-surface transition text-sm text-primary/70">
            ...
            @if($post->excerpt)
                <p class="text-lg text-primary/60 mb-10 leading-relaxed font-light">{{ $post->excerpt }}</p>

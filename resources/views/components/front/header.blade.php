...
<header id="header" x-data="{ open: false, scrolled: false }" @scroll.window="scrolled = window.scrollY > 50"
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-4 flex items-center justify-between gap-4">
        ...
        <div class="hidden md:flex items-center gap-6">
            ...
            @endauth
            <a href="{{ route('appointments.book') }}" class="inline-flex items-center gap-2 bg-accent hover:bg-accent-hover text-white text-sm font-semibold px-5 py-2.5 transition tracking-wide">
                Agendar Cita
            </a>
        </div>
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0"
        ...
        <div class="mt-6">
            <a href="{{ route('appointments.book') }}" class="block w-full text-center bg-accent hover:bg-accent-hover text-white font-semibold px-5 py-3 transition tracking-wide">
                Agendar Cita
            </a>
        </div>
    </div>

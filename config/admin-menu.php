...
return [
    [
        ...
        'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m-4-4h4m6-4v4a1 1 0 01-1 1h-3"/></svg>',
    ],
    [
        'label' => 'Servicios',
        'route' => 'admin.services.index',
        'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>',
    ],
    [
        'label' => 'Proyectos',
    ...
    [
        ...
        'children' => [
            ['label' => 'Artículos', 'route' => 'admin.posts.index'],
            ['label' => 'Categorías', 'route' => 'admin.blog.categories.index'],
        ],
    ],
    [
        'label' => 'Citas',
